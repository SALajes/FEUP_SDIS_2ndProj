...
public class BackupProtocol extends BasicProtocol {
    ...
    public static void sendPutchunk( int sender_id, int replication_degree, String file_id, ArrayList<Chunk> chunks) {
        ...
        for (Chunk chunk : chunks) {
            ...
            Runnable task = () -> processPutchunk(finalSslSocket, putchunk, putchunk.getReplicationDegree(), chunk_id, 0);
    ...
    private static void processPutchunk(SSLSocket sslSocket, PutChunkMessage message, int replication_degree, String chunk_id, int tries) {
        if(tries >= 5){
        ...
        Runnable task = () -> processPutchunk(sslSocket, message, replication_degree, chunk_id, try_aux);
    ...
    private static void sendStored(PutChunkMessage putchunk) {
